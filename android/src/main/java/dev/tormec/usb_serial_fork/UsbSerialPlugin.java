package dev.tormec.usb_serial_fork;
...
public class UsbSerialPlugin implements MethodCallHandler, EventChannel.StreamHandler {
    ...
    UsbSerialPlugin(Registrar registrar) {
        ...
        m_InterfaceId = 100;
        final EventChannel eventChannel = new EventChannel(registrar.messenger(), "usb_serial_fork/usb_events");
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "usb_serial_fork");
